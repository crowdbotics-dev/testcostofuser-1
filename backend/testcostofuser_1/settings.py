"""
Django settings for testcostofuser_1 project.
...
ROOT_URLCONF = 'testcostofuser_1.urls'
...
WSGI_APPLICATION = 'testcostofuser_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testcostofuser_1 API",
    "DESCRIPTION": "API documentation for testcostofuser_1 App",
    "VERSION": "v1",
}
